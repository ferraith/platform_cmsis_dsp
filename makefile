...
#
#============================== Source Directories =====================================================================
PROJ_SRC_DIRS  = src/basic_math_functions
PROJ_SRC_DIRS += src/common_tables
PROJ_SRC_DIRS += src/complex_math_functions
PROJ_SRC_DIRS += src/controller_functions
PROJ_SRC_DIRS += src/fast_math_functions
PROJ_SRC_DIRS += src/filtering_functions
PROJ_SRC_DIRS += src/matrix_functions
PROJ_SRC_DIRS += src/statistics_functions
PROJ_SRC_DIRS += src/support_functions
PROJ_SRC_DIRS += src/transform_functions

#============================== Header Directories =====================================================================
PROJ_INC_DIRS  = include
PROJ_INC_DIRS += include/cmsis_dsp
PROJ_INC_DIRS += src/common_tables
